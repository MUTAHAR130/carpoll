...
@GenerateMocks([], customMocks: [
  ...
  MockSpec<FirService>(onMissingStub: OnMissingStub.returnDefault),
// @stacked-mock-spec
])
...
MockFirService getAndRegisterFirService() {
  _removeRegistrationIfExists<FirService>();
  final service = MockFirService();
  locator.registerSingleton<FirService>(service);
  return service;
}
// @stacked-mock-create
